...
public class Seminarska{
	...
	public static void main(String[] args){
		...
		while(true){
			...
			if(ucinkovitost1 * (cakalna1-1) == cas1){cakalna1--;skupno++;}
			if(ucinkovitost2 * (cakalna2-1) == cas2){cakalna2--;skupno++;}
			if(ucinkovitost3 * (cakalna3-1) == cas3){cakalna3--;skupno++;}
			...
			System.out.format("Postopek je doslej opravilo %d strank.\n", skupno);
		}
