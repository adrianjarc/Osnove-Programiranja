...
public class Seminarska{
	...
	public static void main(String[] args){
		...
		while(true){
			...
			if(novihStrank < 0){
				System.out.format("Najvec strank (%d) se je v prostoru nahajalo v %d. minuti.", rekord, minutaRekorda);
				break;
			}
			...
			if(cakalna1+cakalna2+cakalna3 > rekord){
				rekord = cakalna1+cakalna2+cakalna3;
				minutaRekorda = minuta;
			}
		}
