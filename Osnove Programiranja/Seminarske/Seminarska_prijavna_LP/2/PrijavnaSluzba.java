public class PrijavnaSluzba{
	public static void main(String args[]){
		...
		int[] vrsta = poTipih(tk);
		System.out.format("Stevilo kandidatov s splosno maturo: %d\nStevilo kandidatov s poklicno maturo: %d\n", vrsta[0], vrsta[1]);
	}
	
	private static int[] poTipih(Kandidat[] tk){
		int[] vrsta = new int[2];
