...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Najbolj zastopani paket: %s\n", najboljZastopani(Narocniki));
    }
    ...
    private static String najboljZastopani(Narocnik[] t){
        for (int i=0;i<t.length;i++){
            if (t[i] instanceof Prijatelji){
                p++;
            } else if (t[i] instanceof Mladi){
                m++;
            } else {
                n++;
            }
